    ...
    return (
        <footer className="grid grid-cols-3 bg-black py-10 px-20 text-white">
            <ul className="mt-3 pt-4">
                ...
                <li className="inline"><a href="http://www.twitter.com" target="_blank"><span className="mx-1 text-4xl fa-brands fa-twitter" /></a></li>
                <li className="inline"><a href="http://www.youtube.com" target="_blank"><span className="mx-1 text-4xl fa-brands fa-youtube" /></a></li>
            </ul>
            <div className="text-center">
                <Link href="/">
                    <h1 className="font-mono text-4xl ml-2 pt-4">TIENDA|DE|ROPA</h1>
                </Link>
